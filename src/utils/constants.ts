...
export const PROMPT_MISSING_BASE = `Voici mon cv resumé en text : #__CV . 
pour cette offre : #__DESCRIPTION présente les points manquants de mon cv sous forme de tirets en #__WORDS_SIZE mots`;
export const PROMPT_INTERVIEW_BASE = `Voici mon cv resumé en text : #__CV . 
pour cette offre : #__DESCRIPTION liste 20 questions que le recruteur peut poser à l'entretien en  #__WORDS_SIZE mots dans une liste ordonnée`;
